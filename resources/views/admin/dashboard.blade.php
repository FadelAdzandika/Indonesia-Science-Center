  ...
  {{-- Bagian Manajemen Konten --}}
    <div class="mb-5">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            <div class="col">
                <a href="{{ route('admin.wahanas.index') }}" class="card card-link h-100 text-center shadow-sm border-0">
                    <div class="card-body">
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="{{ route('admin.wahanas.edit', $wahana->id) }}" class="btn btn-warning btn-sm">Edit</a>
      ...
      <tr>
        <td>
          @if($competition->thumbnail)
            <img src="{{ asset('storage/' . $competition->thumbnail) }}" alt="Competition Thumbnail" width="100">
          @else
            Tidak ada gambar
          @endif
        </td>
